...
$sort=12;
$f_type=strtolower("txt|gif|jpg|doc|docx");//设置可上传的文件类型 
...
if($textid=="filename"){
	echo "<script>window.parent.Finish('".$_msg."','" . $uploadfile . "');</script>";	
}elseif($textid=="bigpic"){
	echo "<script>window.parent.FinishBig('".$_msg."','" . $uploadfile . "');</script>";
}
?>
